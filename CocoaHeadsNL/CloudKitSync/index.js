        ...
        var mappedMeetupRecords = meetupEvents.map(function(meetupEvent) {
          ...
          return {recordType: 'Meetup',
            fields: {
              ...
              name: {value: decodeURI(meetupEvent["name"])},
              meetup_description: {value: decodeURI(meetupEvent["description"])},
              locationName: {value: decodeURI(locationName) },
              geoLocation: {value: geoLocation },
              location: {value: decodeURI(location) },
